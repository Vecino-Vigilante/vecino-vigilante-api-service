...
from app.infrastructure.dto.complaint_dto import ComplaintDTO, ComplaintDetailDTO, ComplaintRequestDTO, TypeDTO
...
def map_complaint_model_to_complaint_entity(complaint_model: ComplaintModel) -> Complaint:
    return Complaint(
...
def map_complaint_entity_to_complaint_model(complaint_entity: Complaint) -> ComplaintModel:
    return ComplaintModel(
