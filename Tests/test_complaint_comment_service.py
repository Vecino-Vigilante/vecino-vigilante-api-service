...
class TestComplaintCommentService(unittest.TestCase):
    def setUp(self):
        self.mock_complaint_comment_repository = MagicMock(spec=ComplaintCommentRepository)
    ...
    def test_add_complaint_comment_with_image(self):
        ...
        self.mock_complaint_comment_repository.add_comment.return_value = expected_comment

        comment_data = self.service.add_complaint_comment(complaint_comment, base64_image)
    ...
    def test_get_complaint_comments(self):
        ...
        self.mock_complaint_comment_repository.get_complaint_comments.return_value = expected_comments

        incident_data = self.service.get_complaint_comments(incident_id)

        self.assertEqual(incident_data, expected_comments)
        self.mock_complaint_comment_repository.get_complaint_comments.assert_called_once_with(incident_id)
    ...
    def test_get_comment_by_id_found(self):
        ...
        self.mock_complaint_comment_repository.get_comment.return_value = expected_comment

        comment_data = self.service.get_comment_by_id(comment_id)

        self.assertEqual(comment_data, expected_comment)
        self.mock_complaint_comment_repository.get_comment.assert_called_once_with(comment_id)
    ...
    def test_update_complaint_comment(self):
        ...
        self.mock_complaint_comment_repository.update_comment.return_value = expected_comment

        comment_data = self.service.update_complaint_comment(complaint_comment, base64_image)
    ...
    def test_delete_comment(self):
        ...
        self.mock_complaint_comment_repository.get_comment.assert_called_once_with(comment_id)
        self.mock_complaint_comment_repository.delete_comment.assert_called_once_with(comment_id)
